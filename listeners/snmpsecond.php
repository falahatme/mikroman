...
$snmp['AttainableRate_Downstream'] = snmpget($router_ip, $community, "1.3.6.1.2.1.31.1.1.1.6.10");
$snmp['AttainableRate_Downstream'] = eregi_replace("Gauge32: ","",$snmp['AttainableRate_Downstream']);
$snmp['AttainableRate_Upstream'] = snmpget($router_ip, $community, "1.3.6.1.2.1.31.1.1.1.10.10");
$snmp['AttainableRate_Upstream'] = eregi_replace("Gauge32: ","",$snmp['AttainableRate_Upstream']);
$snmp['Rate_Downstream'] = snmpget($router_ip, $community, "1.3.6.1.2.1.31.1.1.1.6.10");
$snmp['Rate_Downstream'] = eregi_replace("Gauge32: ","",$snmp['Rate_Downstream']) * 1024;
$snmp['Rate_Upstream'] = snmpget($router_ip, $community, "1.3.6.1.2.1.31.1.1.1.10.10");
